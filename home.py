...
#loading the model
model= tf.keras.models.load_model(r'"A:\project\Model_resnet101V2.h5"')

# Get the calss names programmtically
import pathlib
import numpy as np
data_dir = pathlib.Path(r"A:\project\data\raw\New Plant Diseases Dataset(Augmented)\New Plant Diseases Dataset(Augmented)\train")
